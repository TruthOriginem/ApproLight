...
public class ItemPickaxeBase extends ItemPickaxe implements IHasModel, IHasItemSpecialEffects {
    private final EnumSet<ItemSpecialEffect> effects;

    public ItemPickaxeBase(String name, ToolMaterial material, ItemSpecialEffect... effects) {
        super(material);
        if (effects.length > 0) {
