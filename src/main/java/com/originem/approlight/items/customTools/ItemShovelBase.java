...
public class ItemShovelBase extends ItemSpade implements IHasModel, IHasItemSpecialEffects {

    private final EnumSet<ItemSpecialEffect> effects;

    public ItemShovelBase(String name, ToolMaterial material, ItemSpecialEffect... effects) {
        super(material);
        if (effects.length > 0) {
