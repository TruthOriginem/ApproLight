...
public class SlotImmerseFurnaceOutput extends Slot {
    private final EntityPlayer player;
    private int removeCount;

    public SlotImmerseFurnaceOutput(EntityPlayer player, IInventory inventoryIn, int index, int xPosition, int yPosition) {
    ...
    protected void onCrafting(ItemStack stack) {
        ...
        if (!this.player.world.isRemote) {
            ...
            float f = ImmerseFurnaceRecipes.getInstance().getImmerseExperience(stack);
