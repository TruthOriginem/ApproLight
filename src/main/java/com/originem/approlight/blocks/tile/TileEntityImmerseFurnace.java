...
public class TileEntityImmerseFurnace extends TileEntity implements IInventory, ITickable {
    private NonNullList<ItemStack> inventory = NonNullList.withSize(4, ItemStack.EMPTY);
    /*    private static final int ITEM_0_INDEX = 0;
        private static final int ITEM_1_INDEX = 1;
    ...
    public String getName() {
        return this.hasCustomName() ? this.customName : "container.immerse_furnace";
    }
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isBurning()) {
                flag1 = true;
                BlockImmerseFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    public int getCookTime(ItemStack input1, ItemStack input2) {
        return ImmerseFurnaceRecipes.COOKTIME_FOR_EACH_RECIPE;
    }
    ...
    private boolean canSmelt() {
        if (this.inventory.get(0).isEmpty() || this.inventory.get(1).isEmpty())
            ...
            ItemStack result = ImmerseFurnaceRecipes.getInstance().getImmerseResult(this.inventory.get(0), this.inventory.get(1));
    ...
    public void smeltItem() {
        if (this.canSmelt()) {
            ...
            ItemStack result = ImmerseFurnaceRecipes.getInstance().getImmerseResult(input1, input2);
            ItemStack output = this.inventory.get(3);
...
//            if (item == Items.BLAZE_ROD) return 2400;
            if (item instanceof ItemShimmerFuel) {
                return ((ItemShimmerFuel) item).getItemShimmerBurnTime();
            }
//            return ForgeEventFactory.getItemBurnTime(fuel);
    ...
    public String getGuiID() {
        return "approlight:immerse_furnace";
    }
